...
# base url.
AWS_ECS_URL=964858913990.dkr.ecr.eu-west-2.amazonaws.com
AWS_ECS_PROJECT_NAME=cloudserver
AWS_ECS_CONTAINER_NAME=grisplasp
AWS_ECS_DOCKER_IMAGE=grisplasp:latest
AWS_ECS_CLUSTER_NAME=grisplasp-eu-west-2


# Set runtime ENV.
# These are the runtime environment variables.
NODE_NAME=server2
HOST=ec2-18-130-232-107.eu-west-2.compute.amazonaws.com
REMOTE_HOST_1=server3@ec2-35-180-138-155.eu-west-3.compute.amazonaws.com
